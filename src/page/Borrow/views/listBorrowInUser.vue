                ...
                <div class="px-2 w-full">
                  <div class="flex justify-end">
                    ...
                    <template v-if="listRiwayatAll.dataPinjam.status === 2">
                      <p
                        class="font-gunjarati text-end text-[0.5rem] bg-[#ff1616af] w-[max-content] px-1 py-[0.1rem] rounded-[5px] font-semibold"
                      >
                        Belum Dikembalikan
                      </p>
                    </template>
                  ...
                  <div class="mobile:flex mobile:gap-5 justify-around">
                    ...
                    <div>
                      <p class="font-gunjarati text-[10px]">Tanggal Kembali</p>
                      <p class="font-gunjarati text-[10px] text-center">
                        {{
                          momentTanggal(
